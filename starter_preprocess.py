...
class TextPreprocessor:
    ...
    """Handles all the annoying text cleaning so you can focus on the fun 
    stuff"""
    ...
    def fetch_from_url(self, url: str) -> str:
        try:
            ...
            if 'text/plain' not in response.headers['Content-Type']:
                raise Exception(
                    f"The URL does not link to a plain text file. Content-Type: {response.headers['Content-Type']}")
